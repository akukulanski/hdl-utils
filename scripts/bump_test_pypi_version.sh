...
bumpversion --current-version 0.1.0 --new-version $CURRENT_VERSION pyproject.toml
bumpversion patch --current-version $CURRENT_VERSION pyproject.toml --allow-dirty
